                ...
                <div className="flex items-center justify-between h-16">
                    ...
                    <div className="flex">
                        <div className="hidden md:flex md:items-center md:ml-6">
                            <Link to="/login" className="text-2x1 px-3 py-2 text-gray-800 hover:text-blue-600 font-bold">Login</Link>
                            <a href="/register" className="px-3 py-2 text-gray-800 hover:text-blue-600 font-bold">Signup</a>
