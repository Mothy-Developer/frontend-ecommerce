...
function Navbar() {
    ...
    return (
        <nav className="bg-[#F9F6F2] border-b-2 border-black">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex items-center justify-between h-16">
                    <div className="flex-shrink-0">
                        <img className="h-8" src={dummyIcon} alt="Logo" />
                    </div>

                    <div className="flex">
                        <div className="hidden md:flex md:items-center md:ml-6">
                            <a href="#" className="px-3 py-2 text-gray-800 hover:text-gray-600">Login</a>
                            <a href="#" className="px-3 py-2 text-gray-800 hover:text-gray-600">Signup</a>
